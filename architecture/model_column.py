...
class Column_U(nn.Module):
    def __init__(self, kernel_size, first_out_chn, bn=False):
        ...
        self.up_1 = Upsample(int(first_out_chn/2), int(first_out_chn/2), int(first_out_chn/2), int(first_out_chn/4), kernel_size=kernel_size, bn=bn)
        ...
        self.skip_2 = Conv2d(2*first_out_chn, int(first_out_chn/2), 1, same_padding=True, bn=bn)
